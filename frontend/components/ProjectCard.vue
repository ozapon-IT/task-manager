    ...
    <div class="card bg-base-100 shadow-md hover-lift mb-4">
        <div class="card-body p-6">
            <div class="flex justify-between items-start">
                <h2 class="card-title text-lg dark:text-gray-400"
                    :class="{ 'line-through opacity-50': project.completed }">
                    {{ project.title }}
                </h2>
            ...
            <div class="flex justify-between items-center text-sm dark:text-gray-400 mt-4">
            ...
            <div v-if="project.startDate && project.endDate">
                <div class="flex items-center gap-2 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <div class="card-actions justify-end">
                    <BaseButton size="sm" @click="$emit('view', project.id)"
